...
public class OperationControllerTest {
	...
	@TestConfiguration
	static class HotlistServiceTestConfiguration {
		@Bean
		public DataOperationService dataOperationServiceImpl() {
			...
			DataOperationService dataOperationService = Mockito.mock(DataOperationService.class);
			Mockito.when(dataOperationService.uploadFileProcess(Mockito.any(), Mockito.anyString())).thenReturn(value);
